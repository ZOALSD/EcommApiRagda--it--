...
<body dir="rtl">
    <br><br>
    <h4><u>{{ $title }} {{ $card->deliver->name }}</u></h4>
    <table class="table">
        <tr>
            ...
            <th class="right" colspan="3">
                رقم مندوب التوصيل : {{ $card->clint->phone }}
            </th>
        </tr>
        ...
        <tr>
            ...
            <th class="right" colspan="2">مكان العميل </th>
        </tr>
        <tr>
            <td colspan="2"> {{ $card->clint->name }}</td>
            <td>{{ $card->clint->phone }}</td>
            <td colspan="2">{{ $card->area->area_name . ',' . $card->village->village_name }}</td>
        </tr>
