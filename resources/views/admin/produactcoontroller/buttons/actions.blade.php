    ...
    <div class="btn-group">
        ...
        <ul class="dropdown-menu pull-right">
            ...
            @can('ProImageChange')
                ...
                <li>
                    <a href="{{ aurl('/produactcoontroller/' . $id . '/edit') }}"><i class="fa fa-pencil-square-o"></i>
                        {{ trans('admin.edit') }}</a>
                </li>
...
{{--<div class="actions">
    <div class="btn-group">
        ...
        <ul class="dropdown-menu pull-right">
            ...
            <li class="divider"> </li>
            <li>
                <a href="{{ aurl('/produactcoontroller/' . $id) }}"><i class="fa fa-eye"></i>
                    {{ trans('admin.show') }}</a>
            </li>
            <li>
                <a data-toggle="modal" data-target="#delete_record{{ $id }}" href="#">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                {!! Form::open([
                'method' => 'DELETE',
                'route' => ['produactcoontroller.destroy', $id],
                ]) !!}
