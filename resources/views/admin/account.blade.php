        ...
        <div class="col-md-12 col-sm-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    {!! Form::open(['url' => aurl('account'), 'id' => 'account', 'files' => true, 'class' =>
                    'form-horizontal form-row-seperated']) !!}
                    <div class="form-group col-md-6">
                        {!! Form::label('name', trans('admin.name'), ['class' => 'control-label']) !!}
                        <div class="">
                            {!! Form::text('name', admin()->user()->name, ['class' => 'form-control', 'placeholder' =>
                            trans('admin.name')]) !!}
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <div class="">
                            {!! Form::text('email', admin()->user()->email, ['class' => 'form-control', 'placeholder' =>
                            trans('admin.email')]) !!}
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="col-md-6">
                                ...
                                !!}
                                <div class="">
                                    {!! Form::file('photo_profile', ['class' => 'form-control', 'placeholder' =>
                                    trans('admin.photo_profile')]) !!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                @if (!empty(admin()->user()->photo_profile))
                                    <img src="{{ it()->url(admin()->user()->photo_profile) }}"
