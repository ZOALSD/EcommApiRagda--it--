						...
						<div class="portlet-title">
								...
								<div class="actions">
										<a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('ads/create')}}"
												data-toggle="tooltip" title="{{trans('admin.add')}}  {{trans('admin.ads')}}">
												...
												<div class="modal-dialog">
														<div class="modal-content">
																...
																<div class="modal-body">
																		<i class="fa fa-exclamation-triangle"></i>   {{trans('admin.ask_del')}} {{trans('admin.id')}} ({{$ads->id}}) ؟
																</div>
...
{!! Form::open(['url'=>aurl('/ads/'.$ads->id),'method'=>'put','id'=>'ads','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="form-group">
    {!! Form::label('ad_image',trans('admin.ad_image'),['class'=>'col-md-3 control-label']) !!}
    <div class="col-md-9">
        {!! Form::file('ad_image',['class'=>'form-control','placeholder'=>trans('admin.ad_image')]) !!}
        @if(!empty($ads->ad_image))
        <img src="{{it()->url($ads->ad_image)}}" style="width:150px;height:150px;" />
        @endif
    </div>
</div>
<br>
