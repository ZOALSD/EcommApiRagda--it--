...
class VillageDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.village.buttons.actions')
    ...
    {
        return Village::query()->with(['area_id'])->select("villages.*");
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'name' => 'area_id.area_name',
                'data' => 'area_id.area_name',
                'title' => trans('admin.area_id'),
            ],
            [
                'name' => 'village_name',
                'data' => 'village_name',
                'title' => trans('admin.village_name'),
            ],
            [
                'name' => 'actions',
                'data' => 'actions',
