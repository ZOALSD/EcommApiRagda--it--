...
class CategoryCoontrollerDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.categorycoontroller.buttons.actions')

            ->addColumn('color_id', '{{ trans("admin.".$color_id) }}')

            ->addColumn('size_id', '{{ trans("admin.".$size_id) }}')

            ->addColumn('cate_image', 'admin.categorycoontroller.buttons.cate_image')

            ->addColumn('cate_id', '{{ trans("admin.".$cate_id) }}')
	...
	public function query()
    {
	    ...
	    {
	        return 'categorycoontroller_' . time();
	    }
