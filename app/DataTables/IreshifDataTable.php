...
class IreshifDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.ireshif.buttons.actions')

            ->addColumn('invoce_image', 'admin.ireshif.buttons.invoce_image')
            ...
            ->rawColumns(['checkbox', 'actions', 'invoce_image']);
    }
        ...
        //->ajax('')
            ->parameters([
                ...
                'buttons' => [
                    ...
                    // ['extend' => 'reload', 'className' => 'btn blue btn-outline', 'text' => '<i class="fa fa-refresh"></i> ' . trans('admin.reload')],
                    // [
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'name' => 'invoce_image',
                'data' => 'invoce_image',
                'title' => trans('admin.invoce_image'),
            ],
            [
                'name' => 'actions',
                'data' => 'actions',
